...
<html lang="en">
  <head>
    ...
    <title>Laliguras Beauty Parlor | service Page </title>
...
?>
                <div class="col-lg-4 col-md-6 col-sm-6 propClone">
                 <img src="admin/images/<?php echo $row['Image']?>" alt="product" height="250" width="280" class="img-responsive about-me">
