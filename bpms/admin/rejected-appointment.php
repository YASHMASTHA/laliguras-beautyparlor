...
if (strlen($_SESSION['bpmsaid'] == 0)) {
	...
	<head>
		<title>Laliguras Beauty Parlor|| Rejected Appointment</title>
					...
					<div class="tables">
						...
						<div class="table-responsive bs-example widget-shadow">
							...
							<table class="table table-bordered">
								...
								<tbody>
									<?php
									$ret = mysqli_query($con, "SELECT tbluser.FirstName, tbluser.LastName, tbluser.Email, tbluser.MobileNumber, tblbook.ID as bid, tblbook.AptNumber, tblbook.AptDate, tblbook.AptTime, tblbook.Message, tblbook.BookingDate, tblbook.Status, tblbook.Service FROM tblbook JOIN tbluser ON tbluser.ID = tblbook.UserID WHERE tblbook.Status = 'Rejected'");
									$cnt = 1;
									while ($row = mysqli_fetch_array($ret)) {
										...
										<tr>
											...
											<td><?php echo !empty($row['Service']) ? $row['Service'] : '-'; ?></td>
											<!-- Display Service or show '-' if empty -->
