...
<html lang="en">
<head>
    <title>Laliguras Beauty Parlor | Booking History</title>
                                    ...
                                    while ($row = mysqli_fetch_array($query)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="cancel-appointment.php?aptnumber=<?php echo $row['AptNumber']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to cancel this appointment?');">Cancel</a>
                                            </td>
                                        </tr>
                                        <?php $cnt = $cnt + 1; 
                                    } ?>
