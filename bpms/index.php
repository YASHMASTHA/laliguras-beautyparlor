...
<html lang="en">
  <head>
    ...
    <title>Laliguras Beauty Parlor | Home Page</title>
    ...
    <section class="slide slide-one">
      <div class="container">
        <div class="banner-text">
          <h4>Beauty is Power</h4>
          <h3>Where your beauty<br>
           is our Passion </h3>
            ...
            <div class="grids">
                    <div class="grids-content row">
                        ...
                        <div class="column col-lg-4 col-md-6 color-2 ">
                            <div>
                            <h4 class=" ">Our Parlor is Most Popular</h4>
                            <p class="para ">Laliguras Beauty Parlor- Beauty Services</p>
                            <a href="about.php" class="action-button btn mt-md-4 mt-3">Read more</a>
                        </div>
                    </div>
                        <div class="column col-lg-4 col-md-6 col-sm-6 back-image  ">
                            <img src="assets/images/s1.jpeg" alt="product" class="img-responsive ">
                        </div>
                        <div class="column col-lg-4 col-md-6 col-sm-6 back-image2 ">
                            <img src="assets/images/s5.jpg" alt="product" class="img-responsive ">
                          </div>
                    </div>
                </div>
        </div>
	...
	<div class="team-single-main ">
		<div class="container">
				...
				<div class="column2 image-text">
					<h3 class="team-head ">Come experience the satisfactory services</h3>
					<p class="para  text ">
						Best Beauty expert at your service provides beauty parlor. Beauty parlor provided with well trained beauty professionals for beauty services including Facial,Bridal Makeup, Waxing,Pedicure, Manicure, etc.</p>
        ...
        <div class="container">
            <div class=" row">
                <div class="col-lg-6 back-image">
                    <img src="assets/images/par.webp" alt="product" class="img-responsive ">
                </div>
                <div class="col-lg-6 about-right-faq align-self">
                    <h3 class="title-big"><a href="about.html">Clean and Recommended Beauty Parlor</a></h3>
                    ...
                    <div  class="image-right">
                        <ul class="w3l-right-book">
                            <li><span class="fa fa-check" aria-hidden="true"></span><a href="about.html">Bridal Makeup</a></li>
                            <li><span class="fa fa-check" aria-hidden="true"></span><a href="about.html">Hair Treatment</a></li>
                            <li><span class="fa fa-check" aria-hidden="true"></span><a href="about.html">Party Makeup</a></li>
                            <li><span class="fa fa-check" aria-hidden="true"></span><a href="about.html">Simple Glam Makeup</a></li>
                            <li><span class="fa fa-check" aria-hidden="true"></span><a href="about.html">Hairstyles</a></li>
                        </ul>
                </div>
            </div>
        </div>
